...
@Component
public class ReportLossButton implements ButtonAction {
    private final DuelRepository duelRepository;
    private final DuelService duelService;

    public ReportLossButton(DuelRepository duelRepository, DuelService duelService) {
    ...
    public String getAction() {
        return Buttons.REPORT_LOSS_BUTTON;
    }
}
